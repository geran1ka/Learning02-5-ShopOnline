...
( function( factory ) {
	...
	if ( true ) {
		...
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(755), __webpack_require__(592) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
;// CONCATENATED MODULE: ./src/js/module/createElem.js
const createElem_createElem = (tag, attr) => {
...
;// CONCATENATED MODULE: ./src/js/module/const.js
const API_URL_POST = 'https://gorest.co.in/public-api/posts';
const API_URL_USER = 'https://gorest.co.in/public-api/user';
const headerContainer = document.querySelector('.header__container_main');
;// CONCATENATED MODULE: ./src/js/module/serviceApi.js
const getDataArticle = async (url, id = '') => {
  const result = await fetch(`${url}/${id}`);
  const data = await result.json();
  return data;
};
;// CONCATENATED MODULE: ./src/js/module/paginationControl.js



const paginationController = async (pagination, linkBack, linkNext, page, pages) => {
...
;// CONCATENATED MODULE: ./src/js/module/renderPagination.js

const renderPagination = data => {
  const pagination = createElem_createElem('footer', {
    className: 'blog-pagination'
  });
  const linkBack = createElem_createElem('a', {
  ...
  const linkNext = createElem_createElem('a', {
    className: 'blog-pagination__link',
    href: '#',
    innerHTML: `
      <svg width="29" height="19" viewBox="0 0 29 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  const paginationList = createElem_createElem('ul', {
    className: 'blog-pagination__list'
  });
  if (page > pages - 1) {
    console.log('page - 2');
    const paginationItem = createElem_createElem('li', {
  ...
  if (page > 1) {
    console.log('page - 1');
    const paginationItemTwo = createElem_createElem('li', {
      className: 'blog-pagination__item',
      textContent: page - 1
    });
    paginationList.append(paginationItemTwo);
  }
  const paginationItemThree = createElem_createElem('li', {
    className: 'blog-pagination__item blog-pagination__item_active',
    textContent: page
  });
  paginationList.append(paginationItemThree);
  if (page < pages) {
    const paginationItemFour = createElem_createElem('li', {
      className: 'blog-pagination__item',
      textContent: page + 1
    });
  ...
  if (page < 2) {
    const paginationItemFive = createElem_createElem('li', {
      className: 'blog-pagination__item',
      textContent: page + 2
    });
...
;// CONCATENATED MODULE: ./src/js/module/renderBlog.js



const renderBlog = data => {
  const section = createElem_createElem('section', {
    className: 'blog'
  });
  const container = createElem_createElem('div', {
  ...
  const blogContentWrapper = createElem_createElem('div', {
    className: 'blog__container'
  });
  const blogList = createElem_createElem('ul', {
    className: 'blog__list'
  });
  const itemList = data.data.map(item => {
    const li = createElem_createElem('li', {
      className: 'blog__item blog-item'
    });
    const itemImg = createElem_createElem('img', {
      className: 'blog-item__img',
      src: item.image ? item.image : './img/blog/no-photo.jpg',
      alt: '#'
    });
    const itemContent = createElem_createElem('div', {
      className: 'blog-item__content-wrapper'
    });
    const itemTitle = createElem_createElem('h2', {
      className: 'blog-item__title'
    });
    const itemTitleLink = createElem_createElem('a', {
      className: 'blog-item__title-link',
      href: `article.html?id=${item.id}`,
      textContent: `${item.title}`
    });
    itemTitle.append(itemTitleLink);
    const itemInfoWrapper = createElem_createElem('div', {
      className: 'blog-item__info'
    });
    const itemData = createElem_createElem('div', {
      className: 'blog-item__date date'
    });
    const time = createElem_createElem('p', {
      textContent: '22 октября 2021, 12:45'
    });
    itemData.append(time);
    const itemCountWrapper = createElem_createElem('div', {
      className: 'blog-item__count-wrapper'
    });
    const linkViewsCounter = createElem_createElem('a', {
      className: 'blog-item__views-link',
      href: '#',
      innerHTML: `
        <svg class="blog-item__views-icon" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const linkViewsComent = createElem_createElem('a', {
      className: 'blog-item__views-link',
      href: '#',
      innerHTML: `
        <svg class="blog-item__views-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    itemInfoWrapper.append(itemData, itemCountWrapper);
    itemContent.append(itemTitle, itemInfoWrapper);
...
;// CONCATENATED MODULE: ./src/js/module/createAside.js

const createAside = () => {
  const aside = createElem_createElem('aside', {
    className: 'aside'
  });
  const container = createElem_createElem('div', {
    className: 'aside-container'
  });
  const asideBlockOne = createElem_createElem('div', {
  ...
  const asideBlockTwo = createElem_createElem('div', {
...
;// CONCATENATED MODULE: ./src/js/module/createAticle.js

const createArticle = async data => {
  const userId = data.data.user_id;
  const authorName = await (await fetch(`https://gorest.co.in/public-api/users/${userId}`)).json();
  const articleMain = createElem_createElem('div', {
    className: 'article-main'
  });
  const container = createElem_createElem('container', {
    className: 'article-main__container'
  });
  const articleTitle = createElem_createElem('h2', {
    className: 'article-main__title',
    textContent: data.data.title
  });
  const articleContent = createElem_createElem('div', {
    className: 'article-main__content'
  });
  const firstParagraf = createElem_createElem('p', {
  ...
  const footer = createElem_createElem('footer', {
    className: 'article-footer'
  });
  const footerContainer = createElem_createElem('div', {
    className: 'article-main__container article-footer__container'
  });
  const footerNavigation = createElem_createElem('div', {
    className: 'article-footer__navigation'
  });
  const footerLink = createElem_createElem('a', {
  ...
  const footerDevelopment = createElem_createElem('div', {
    className: 'article-footer__development'
  });
  const author = createElem_createElem('p', {
    className: 'article-footer__author',
    textContent: authorName.data.name ? authorName.data.name : 'Аноним'
  });
  const footerInfoWrapper = createElem_createElem('div', {
    className: 'article-footer__info'
  });
  const footerDate = createElem_createElem('div', {
    className: 'article-footer__date',
    innerHTML: `
      <p>22 октября 2021, 12:45</p>
    `
  });
  const footerCountWrapper = createElem_createElem('div', {
    className: 'article-footer__count-wrapper'
  });
  const footerViewsLink = createElem_createElem('a', {
  ...
  const footerCommentLink = createElem_createElem('a', {
    className: 'article-footer__views-link',
    href: `#`,
    innerHTML: `
...
;// CONCATENATED MODULE: ./src/js/module/renderArticle.js
...
const renderArticle = async () => {
  ...
  const article = createElem_createElem('article', {
    className: 'article'
  });
  const container = createElem_createElem('div', {
...
;// CONCATENATED MODULE: ./src/js/module/timer/timerRender.js

const timerRender = timer => {
  const timerTitle = createElem_createElem('p', {
    classList: 'timer__title',
    textContent: 'До конца акции:'
  });
  const timerItemDays = createElem_createElem('p', {
    classList: 'timer__item timer__item-days'
  });
  const timerCountDays = createElem_createElem('span', {
    classList: 'timer__count timer__count-days'
  });
  const timerUnitsDays = createElem_createElem('span', {
    classList: 'timer__units timer__units-days'
  });
  timerItemDays.append(timerCountDays, timerUnitsDays);
  const timerItemHours = createElem_createElem('p', {
    classList: 'timer__item timer__item-hours'
  });
  const timerCountHours = createElem_createElem('span', {
    classList: 'timer__count timer__count-hours'
  });
  const timerUnitsHours = createElem_createElem('span', {
    classList: 'timer__units timer__units-hours'
  });
  timerItemHours.append(timerCountHours, timerUnitsHours);
  const timerItemMinutes = createElem_createElem('p', {
    classList: 'timer__item timer__item-minutes'
  });
  const timerCountMinutes = createElem_createElem('span', {
    classList: 'timer__count timer__count-minutes'
  });
  const timerUnitsMinutes = createElem_createElem('span', {
...
;// CONCATENATED MODULE: ./src/js/module/timer/decl0fNum.js
...
;// CONCATENATED MODULE: ./src/js/module/timer/getTwoDigits.js
const getTwoDigits = num => ('0' + num).slice(-2);
;// CONCATENATED MODULE: ./src/js/module/timer/timerControl.js
...
;// CONCATENATED MODULE: ./src/js/module/timer/timerInit.js
...
// EXTERNAL MODULE: ./node_modules/jquery-ui/ui/widgets/accordion.js
var accordion = __webpack_require__(71);
;// CONCATENATED MODULE: ./src/js/module/scrollControl.js
const scrollController = {
  disabledScroll() {
    0, document.body.style.cssText = `
      overflow: hidden;
      position: fixed;
...
;// CONCATENATED MODULE: ./src/js/module/menu&accControl.js



const catalog = jquery('.footer__catalog');
const info = jquery('.footer__info');
const menuCatalog = jquery('.menu__catalog');
const menuInfo = jquery('.menu__info');
const menuContacts = jquery('.menu__contacts');
const menu = jquery('.header__menu');
const menuBtn = jquery('.header__btn-menu');
...
const menuControll = () => {
  ...
  jquery('body').on('click', e => {
    ...
    } else if (e.target.closest('.menu__info-link') || e.target.closest('.menu__info-link') || e.target.closest('.menu__contacts-link')) {
      closeMenuA();
    }
  });
};
...
;// CONCATENATED MODULE: ./src/js/module/data.js
const data_data = {
...
;// CONCATENATED MODULE: ./src/js/module/createCard.js
...
const createCard = () => {
  ...
  const cardPriceNew = createElem('span', {
    ...
    textContent: data.discount ? `${data.price - data.price * data.discount / 100} ₽` : `${data.price} ₽`
  });
