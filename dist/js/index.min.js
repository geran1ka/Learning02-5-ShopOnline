...
const accordionInit=o=>{o.accordion({active:!0,collapsible:!0,heightStyle:"content",icons:{header:"footer__accord-icon",activeHeader:"footer__accord-icon footer__accord-icon_active"}})};export const controllAccordeon=()=>{const o=$(".footer__catalog"),c=$(".footer__info");let n=!1;window.innerWidth<=640&&(accordionInit(o),accordionInit(c),n=!0),window.addEventListener("resize",(()=>{window.innerWidth<=640?(accordionInit(o),accordionInit(c),n=!0):n&&(o.accordion("destroy"),c.accordion("destroy"),n=!1)}))};controllAccordeon();